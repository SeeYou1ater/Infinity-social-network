...
describe('Status component', () => {
  /*test('status from props should be in the state', () => {
    const component = create(<ProfileStatus updateStatus={x => x} isOwner={true} status='status'/>)
  ...
  /*test('callback should be called', () => {
    ...
    const component = create(<ProfileStatus isOwner={true} status='status' updateStatus={mockCallback}/>)
    const instance = component.getInstance()
